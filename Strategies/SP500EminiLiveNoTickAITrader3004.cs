...
{
    public class SP500EminiLiveNoTickAITrader3004 : Strategy
    {
        ...
        private static readonly int Pstopss = 20;
        private static readonly int Lstops = 10;
        private static readonly int profitChasing = Pstopss * TicksPerStop; // the target where HandleProfitChasing kicks in
        private static readonly int softDeck = Lstops * TicksPerStop; // number of stops for soft stop loss
        private static readonly int hardDeck = Pstopss * TicksPerStop; //hard deck for auto stop loss
        private static readonly int portNumber = 3004;
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "SP500EminiLiveNoTickAITrader3004";
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (BarsInProgress == 0)
            {
                ...
                else
                {
                    ...
                    // record high of day and low of day during trading hours
