...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class SP500EminiLiveLowTickT63001 : Strategy
    {
        ...
        private static double MACDDiffThreshold = 0.05;
        private static double ProfitPercentage = 0.75;
        ...
        {
            MyPrint(defaultErrorType, "IsTradeInterrupted Checked. ((Close[0] < SMA(SMAConstant)[0]) && (Close[0] >= (closedPrice + ProfitPercentage * pStops)))");
