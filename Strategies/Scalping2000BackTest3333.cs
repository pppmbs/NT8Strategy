...
{
    public class Scalping2000BackTest3333 : Strategy
    {
        ...
        private void MyPrint(ErrorType errType, string buf)
        {
            if (swLog == null)
            {
                ...
                pathLog = System.IO.Path.Combine(pathLog, "Scalping2000BackTest3333" + "-" + DateTime.Today.ToString("yyyyMMdd") + ".log");
