    ...
    public class TServerBackTest3883 : Strategy
    {
        ...
        private void MyErrPrint(ErrorType errType, string buf)
        {
            ...
            if (swErr == null)
            {
                ...
                pathErr = System.IO.Path.Combine(pathErr, "Backtest" + "-" + vPortNumber.ToString() + "-" + DateTime.Today.ToString("yyyyMMdd") + ".err");
        ...
        private void MyPrint(ErrorType errType, string buf)
        {
            if (swLog == null)
            {
                ...
                pathLog = System.IO.Path.Combine(pathLog, "Backtest" + "-" + vPortNumber.ToString() + "-" + DateTime.Today.ToString("yyyyMMdd") + ".log");
            ...
            if (errType != ErrorType.normal)
            {
                ...
                if (State == State.Historical)
                    Print(hostName + ":" + vPortNumber.ToString() + ":" + Time[0].ToShortDateString() + " " + Time[0].ToLongTimeString() + " " + buf);
                else
