...
{
    public class SP500EminiLiveNoTickAITrader3003 : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "SP500EminiLiveNoTickAITrader3003";
        ...
        private void ComputeDynamicPstopsLstops(double highOfDay, double lowOfDay)
        {
            ...
            // 40% of the daily range between peak and trough, round to even number
            pStops = (int)Math.Round((highOfDay - lowOfDay) * 0.4, MidpointRounding.ToEven);
            ...
            // save pStops and lStops in files respectively 
