...
{
    public class AGG6BarPlus : Strategy
    {
        private int Fast;
        private int Slow;
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = @"Like AGG6Bar but less aggressive in profit chasing, check Server Signal, EXIT if market against position AND Server Signal is NOT same as postion, ";
                Name = "AGG6BarPlus";
...
In our case it is a 2000 ticks bar. */
        ...
        private void HandleProfitChasing(string signal)
        {
            ...
            // if market trend go against profit positions and server signal is not SAME as current position, then flatten position and take profits
            if (PosLong())
            {
