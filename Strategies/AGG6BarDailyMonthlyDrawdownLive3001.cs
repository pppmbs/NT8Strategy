...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class AGG6BarDailyMonthlyDrawdownLive3001 : Strategy
    {
        ...
        private void MyPrint(string buf)
        {
            ...
            {
                swLog.WriteLine(DateTime.Today.ToString() + " " + buf); // Append a new line to the log file
                Print(DateTime.Today.ToString() + " " + buf);
            }
        ...
        private void PrintProfitLossCurrentCapital()
        {
            ...
            MyPrint("$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
            MyPrint("PrintProfitLossCurrentCapital, Curret capital is: " + currentCapital);
            MyPrint("$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
