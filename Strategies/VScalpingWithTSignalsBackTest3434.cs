...
{
    public class VScalpingWithTSignalsBackTest3434 : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Description = @"Implements back test for V Scalping using T signals.";
                Name = "VScalpingWithTSignalsBackTest3434";
        ...
        private void MyErrPrint(ErrorType errType, string buf)
        {
            ...
            if (swErr == null)
            {
                ...
                pathErr = System.IO.Path.Combine(pathErr, "VScalpingWithTSignalsBackTest3434" + "-" + tPortNumber.ToString() + "-" + DateTime.Today.ToString("yyyyMMdd") + ".err");
        ...
        private void MyPrint(ErrorType errType, string buf)
        {
            if (swLog == null)
            {
                ...
                pathLog = System.IO.Path.Combine(pathLog, "VScalpingWithTSignalsBackTest3434" + DateTime.Today.ToString("yyyyMMdd") + ".log");
