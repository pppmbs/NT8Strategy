...
{
    public class AGG5MixBackup : Strategy
    {
        private int Fast;
        private int Slow;
        ...
        private static readonly int profitChasing = 18 * 4; // the target where HandleProfitChasing kicks in
        ...
        private static readonly int hardDeck = 8 * 4; //hard deck for auto stop loss
